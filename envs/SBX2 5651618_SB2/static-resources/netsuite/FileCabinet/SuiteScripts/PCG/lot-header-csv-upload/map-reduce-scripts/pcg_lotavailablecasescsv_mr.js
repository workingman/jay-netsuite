...
define([
    ...
    function getInputData() {
        ...
        try {
            csvFile = file.load({
                id: 'TFI Files/Lot Number Records/LotAvailableCasesUpload.csv'
            });
        } catch (e) {
            log.error({
    ...
    function reduce(reduceContext) {
        try {
            ...
            const lotAvailableCases = csvFileValues[2];
            ...
            const inventoryNumberId = record.submitFields({
                ...
                values: {
                    'custitemnumber_tfi_pcg_lot_avail_cases': lotAvailableCases
                },
                options: {
